...
/obj/Item/Ranged/
	...
	MinRange = 0
	MaxRange = 35
	BaseDamageType = DamageTypePiercing
	BypassCover = FALSE //Ranged weapons are affected by cover
	Targets = ~TargetAllies

/obj/Item/Ranged/AttackTarget(var/atom/Target)
	Shoot(Target)
